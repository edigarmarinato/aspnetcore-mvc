    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idCamaradas = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Nome = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    Sobrenome = table.Column<string>(type: "TEXT", maxLength: 45, nullable: false),
                    CPF = table.Column<string>(type: "TEXT", maxLength: 14, nullable: false),
                    DataNascimento = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Camaradas", x => x.idCamaradas);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@email.com", true, "Administrador do Sistema", "$2a$10$SR83N6Qja94Ytw5UdE8hZ.TXNplxIB.qqzPcba/5lNWwGNDQzGuG." });
